...
{
    [Serializable]
    public class AuthenticationRequiredException : ApplicationException
    {
        /// <summary>
        ...
        protected AuthenticationRequiredException(SerializationInfo serializationInfo, StreamingContext streamingContext)
