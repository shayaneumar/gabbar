...
{
    [Serializable]
    public class UntrustedCertificateException : ApplicationException
    {
        /// <summary>
        /// Initializes a new instance of <see cref="AuthenticationRequiredException"/>
        /// </summary>
        ...
        public UntrustedCertificateException(string message, Exception innerException)
            : base(message, innerException)
        {
        }

        /// <summary>
        /// Initializes a new instance of the AuthenticationRequiredException class with serialized data.
        /// </summary>
        ...
        protected UntrustedCertificateException(SerializationInfo serializationInfo, StreamingContext streamingContext)
